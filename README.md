...
Visual outputs generated by the library using `black_woodpecker.wav` as input. These include STFT spectrograms, Mel spectrograms, and MFCC heatmaps, rendered with both built-in and OpenCV-like color schemes.
...
|------------------------|---------------------------------------------|---------|
| **Mel Spectrogram**<br/>(Cividis) | Visualizes the Mel filter bank output | ![Mel Spectrogram](outputs/functions/black_woodpecke_mel.png) |
| **MFCC**<br/>(Blues Soft)        | Displays cepstral coefficients for feature extraction | ![MFCC](outputs/functions/black_woodpecke_mfcc.png) |
